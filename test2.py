...
state_space = (3, env.observation_space)#env.observation_space.shape[0]
action_space = env.action_space.n
max_steps = 300
num_episodes = 5000

model = DQN(state_space, action_space, hidden_size=64, batch_size=64, target_update_freq=10000, model="2")
